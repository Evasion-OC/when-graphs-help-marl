...
manuscript (`paper/`), and the journal submission build
(`paper/main_jaamas.tex`, generated by `paper/_assemble_jaamas.py`) all
live here. The deliverable is the summary-CSV → stats → figures → paper
