...
the rule sharp: in the gridworld headline (Section~\ref{sec:structure:headline}),
all-to-all communication and a density-matched wrong graph both sat at the
no-communication floor; in the token-matching task all-to-all managed only weak,
task-incidental routing (Section~\ref{sec:structure:tokenmatch})---in neither
case approaching the task-matched graph. Pointing the channel at the wrong
neighbours wastes it; broadcasting to everyone does not rescue it. Where the
