...
question. \emph{(i) The attention arms are emphatically not under-trained:} given the
...
\gtrue\ at \SCtrueN; gap $\SCgatTrueGap$, n.s., Welch $p=\SCgatTrueP$), and
multi-head DGN actually \emph{exceeds} it (\texttt{dgn\_true} $71.50$, $+5.4$ over
\gtrue, Welch $p_{\text{Holm}}=0.007$). \emph{(ii) Over
all-to-all, both attention mechanisms still floor:} \gtrue\ beats
