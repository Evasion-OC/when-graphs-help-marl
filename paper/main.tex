...
graph-diameter grid (H3). [PLACEHOLDER: one-sentence summary of which
hypotheses survived once results are in.] We distill the most actionable
finding into a depth--diameter alignment heuristic that practitioners can
apply without an architecture sweep, and release the harness, configs, and
...
\begin{enumerate}[leftmargin=*,itemsep=0pt,topsep=2pt]
  ...
  \item We find [SUMMARY FROM RESULTS]. The depth--diameter alignment is
