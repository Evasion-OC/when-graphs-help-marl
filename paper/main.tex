...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.62\textwidth]{figures/phase8_capacity_control.png}
...
\begin{figure}[h!]
  ...
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth]{figures/phase8_curves_N4.png}
    \caption{$N=4$ (ring).}
  \end{subfigure}\hfill
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth]{figures/phase8_curves_N8.png}
    \caption{$N=8$ (ring).}
  \end{subfigure}
