...
bias buys nothing and pays for the cost of representing a uniform graph
...
(\qmix) is a better fit. We did not observe systematic damage from
deploying \gnnqmix\ where it was not needed, but the parameter overhead
and tuning cost are real.
...
\begin{table}[h!]
  ...
  \begin{tabular}{lrrr}
    \toprule
    Phase & Pre-registered (env steps) & Executed (env steps) & Reason for scaling \\
    \midrule
    1 (pilot)       & $5 \times 10^4 \times 3 \times 4$  & [INSERT]
                    & matches pre-reg. \\
    2 (E1 sweep)    & $2 \times 10^5 \times 5 \times 4 \times 3 \times 2$ & [INSERT]
                    & CPU envelope. \\
    3 (MPE)         & $\geq 10^6 \times 5 \times 4 \times 2$ & [INSERT]
                    & CPU envelope. \\
    4 (ablation)    & $\geq 5 \times 10^4 \times \cdots$  & [INSERT]
                    & CPU envelope. \\
    \bottomrule
  \end{tabular}
\end{table}
